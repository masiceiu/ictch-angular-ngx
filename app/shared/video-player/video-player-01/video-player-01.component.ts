...
@Component({
  selector: 'app-video-player-01',
  templateUrl: './video-player-01.component.html',
  styleUrls: ['./video-player-01.component.css']
})
export class VideoPlayer01Component implements OnInit {
